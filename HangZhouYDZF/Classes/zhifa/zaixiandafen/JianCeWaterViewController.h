...
@interface JianCeWaterViewController : UIViewController<NSXMLParserDelegate,UITableViewDataSource,UITableViewDelegate,ChooseRecordDelegate,refreshScoreDelegate>{
