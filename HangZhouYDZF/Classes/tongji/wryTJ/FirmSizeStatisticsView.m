...
@implementation FirmSizeStatisticsView
...
- (void)addView:(int)type {
	...
	switch (type) {
		...
		case 1:
		{
            ...
            [countArray release];
			pieView.colorArr = [NSArray arrayWithObjects:[UIColor colorWithRed:(0xff/255.0f) green:(0x00/255.0f) blue:(0x00/255.0f) alpha:1.0],[UIColor colorWithRed:(0x00/255.0f) green:(0x00/255.0f) blue:(0x00/255.0f) alpha:1.0],[UIColor colorWithRed:(0x00/255.0f) green:(0xb0/255.0f) blue:(0xf0/255.0f) alpha:1.0],[UIColor colorWithRed:(0x0c/255.0f) green:(0xde/255.0f) blue:(0x5c/255.0f) alpha:1.0],[UIColor colorWithRed:(0x72/255.0f) green:(0x00/255.0f) blue:(0xff/255.0f) alpha:1.0],[UIColor colorWithRed:(0x9e/255.0f) green:(0x1e/255.0f) blue:(0x00/255.0f) alpha:1.0],nil];
